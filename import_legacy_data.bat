...
set "MERGE_PS1=%SCRIPTS_DIR%\merge.ps1"
set "MERGED_NOTES=%DATA_DIR%\tutte_le_note.txt"
...
if not exist "%NOTES_DIR%" (
  echo ERRORE: cartella delle note non trovata: "%NOTES_DIR%"
  exit /b 1
)
...
echo [1/3] Unisco i file XML presenti in "%NOTES_DIR%"...
...
echo File unito trovato: "%MERGED_NOTES%"
