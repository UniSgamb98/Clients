...
public class SchedaClienteView extends BorderPane {
    ...
    private final Button newAnnotationButton;
    ...
    public SchedaClienteView() {
        ...
        newAnnotationButton = new Button("+ Nuova annotazione");
        newAnnotationButton.getStyleClass().add("clients-primary-button");
        ...
        saveNoteButton = new Button("Salva annotazione");
        ...
        noteEditor.getChildren().addAll(noteTextArea, createNoteActions());
        hideNoteEditor();
    ...
    private VBox createTimelineSection() {
        ...
        actions.getChildren().add(newAnnotationButton);
        section.getChildren().add(1, actions);
        section.getChildren().add(2, noteEditor);
        return section;
    }
    ...
    public void renderProfile(ClienteProfile profile) {
        ...
        nextInteractionLabel.setText("Prossimo contatto -");
    ...
    private void renderTimeline(List<InteractionPreview> interactions) {
        ...
        for (InteractionPreview interaction : interactions) {
            ...
            Label title = createInfoLabel(DATE_FORMATTER.format(interaction.data()) + " · " + interaction.titolo());
            title.getStyleClass().add("client-profile-timeline-title");
            Label text = createInfoLabel(interaction.testo());
    ...
    public Button getNewAnnotationButton() {
        return newAnnotationButton;
    }
