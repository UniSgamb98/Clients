...
public final class SchedaClienteModels {
    ...
    public record InteractionEditInput(UUID notaId, UUID interazioneId, LocalDate data, LocalDateTime createdAt, InteractionType type, LocalDate prossimoContatto, CallOutcome esito, String testo) {
        public static InteractionEditInput from(InteractionPreview interaction) {
            return new InteractionEditInput(interaction.notaId(), interaction.interazioneId(), interaction.data(), interaction.createdAt(), interaction.type(), interaction.prossimoContatto(), interaction.esito(), interaction.testo());
        }
    }

    public record InteractionPreview(UUID notaId, UUID interazioneId, LocalDate data, LocalDateTime createdAt, InteractionType type, LocalDate prossimoContatto, CallOutcome esito, String testo) {
    }
}
