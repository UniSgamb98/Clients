...
public class ImpostazioniView extends BorderPane {
    ...
    private VBox createSection(String title) {
        ...
        List<String> fields = switch (table) { case "MATERIALI_DI_CONSUMO" -> List.of("Materiale", "Marchio", "Modello", "Nota"); case "CANALI_DI_ACQUISTO" -> List.of("Modalità", "Nota"); case "FRESATORI" -> List.of("Marca", "Modello"); default -> List.of("Tecnologia", "Anno", "Marca", "Modello"); };
